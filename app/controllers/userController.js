...
let applicationUrl="http://localhost:4200";
/* Models */
...
let loginFunction = (req, res) => {
    ...
    let validatePassword = (retrievedUserDetails) => {
        ...
        return new Promise((resolve, reject) => {
            generatePasswordLib.comparePassword(req.body.password, retrievedUserDetails.password, (err, isMatch) => {
                if (err) {
                    console.log(err)
                ...
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        html: `<h4> Hi ${tokenDetails.userDetails.firstName}</h4>
                            ...
                            <br><b>Regard & Thanks</b>
                            <br><b>Todo App</b>
                                        `
                    }
    
                    setTimeout(() => {
                        resetPasswordEmail.sendEmail(sendEmailOptions);
                    }, 2000);
