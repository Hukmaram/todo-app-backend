...
// const resetPasswordEmail = require('../libs/resetPasswordEmail');
...
let getAllListsFunction = (req, res) => {
    ...
    let findLists = () => {
        return new Promise((resolve, reject) => {
            ...
            ListModel.find({ 'todoListCreatorId': req.params.userId})
                .select()
                .lean()
...
let getAllPublicListsFunction = (req, res) => {
    ...
    let findLists = (userDetails) => {
        return new Promise((resolve, reject) => {
            ...
            ListModel.find({ 'todoListCreatorId': { $in:  userIds }})
                .select()
                .lean()
                .exec((err, ListDetails) => {
                    if (err) {
...
let deleteListFunction = (req, res) => {
    ...
    let deleteList = (ListDetails) => {
        return new Promise((resolve, reject) => {
            ...
            ListModel.findOneAndRemove({ 'todoListId': req.params.todoListId }).exec((err, result) => {
                if (err) {
                    console.log(err)
...
let updateListFunction = (req, res) => {
    ...
    let updateList = (ListDetails) => {
        return new Promise((resolve, reject) => {
            ...
            ListModel.update({ 'todoListId': req.params.todoListId }, options).exec((err, result) => {
                if (err) {
                    console.log(err)
...
let addListFunction = (req, res) => {
    ...
    let validateUserInput = () => {
        return new Promise((resolve, reject) => {
            if (req.body.todoListName && req.body.todoListCreatorId && req.body.todoListCreatorName &&
                req.body.todoListModifierId && req.body.todoListModifierName && req.body.todoListMode ) {
                resolve(req)
            } else {
    ...
    let addList = () => {
        return new Promise((resolve, reject) => {
            ...
            let newList = new ListModel({
                ...
                todoListCreatorId: req.body.todoListCreatorId,
                todoListCreatorName: req.body.todoListCreatorName,
                todoListModifierId: req.body.todoListModifierId,
                todoListModifierName: req.body.todoListModifierName,
                todoListMode: req.body.todoListMode,
            })
